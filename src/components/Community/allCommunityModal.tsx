...
import CreateCommunityModal from "../Modal/CreateCommunity/CreateCommunityModal";
  ...
  const AllCommunityModal: React.FC = () => {
    ...
    return (
      ...
      >
        <Flex
          ...
          fontWeight={600}
          bgImage="url('/images/allcommunities.png')"
          ...
          {loading ? (
            ...
            <>
              {communities.map((item, index) => {
                ...
                return (
                  <Link key={item.id} href={`/healthclique/${item.id}`}>
                    <Flex
                      position="relative"
                      align="center"
                      fontSize="10pt"
              ...
              <Box p="10px 20px">
                <Button height="30px" width="100%" bg="brand.100"  onClick={handleCreateCommunityClick} // Add onClick handler
